...
optimized = None  
# Needed because optimized in functions/optimized/test_func is generated by cython after running Option 0. 
def try_import_optimized():
    ...
    while optimized is None:
        try:
            ...
            print("\n Optimized function not yet in dir. Retrying in 45 seconds...")
            time.sleep(45)  
...
def menu():
    print("\n--- Menu ---")
    print("0. Optimize a function (Currently predefined)")
...
def compare_functions():
    ...
    if optimized:
        ...
        print("\n⚠️ Optimized function is still being imported. Please try again later.")
